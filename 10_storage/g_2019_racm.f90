...
!
! ifort -O2 -axAVX -lnetcdff -L$NETCDF/lib -I$NETCDF/include g_2019_racm.f90 -o racm2019.exe
!
!
...
module varsr
    ...
    integer,parameter :: ipm=48  ! Posicion del archivo PM2.5
    integer,parameter :: icn=55    ! Posicion archivo CN del INEM
    integer,parameter :: jcn=52    ! Posicion archivo CN de especiacion
    integer,parameter :: imt=54    ! Posicion archivo CH4 del INEM
...
subroutine lee
    ...
    'RACM2_CH4_A.txt','RACM2_ETH_A.txt','RACM2_HC3_A.txt' ,'RACM2_HC5_A.txt', 'RACM2_HC8_A.txt',&
    'RACM2_ETE_A.txt','RACM2_OLI_A.txt','RACM2_OLT_A.txt' ,'RACM2_DIEN_A.txt','RACM2_BEN_A.txt',&
    'RACM2_TOL_A.txt','RACM2_XYM_A.txt','RACM2_XYP_A.txt' ,'RACM2_XYO_A.txt','RACM2_HCHO_A.txt',&
    'RACM2_ALD_A.txt','RACM2_ACT_A.txt','RACM2_MEK_A.txt' ,'RACM2_KET_A.txt', 'RACM2_ROH_A.txt',&
    'RACM2_HKET_A.txt','RACM2_CSL_A.txt','RACM2_PHEN_A.txt','RACM2_API_A.txt','RACM2_ISO_A.txt',&
    'RACM2_LIM_A.txt','RACM2_MVK_A.txt','RACM2_MACR_A.txt','RACM2_ONIT_A.txt','RACM2_GLY_A.txt',&
    'RACM2_MGLY_A.txt','RACM2_UALD_A.txt','RACM2_ACD_A.txt','RACM2_ORA2_A.txt','RACM2_ACE_A.txt',&
    'RACM2_BALD_A.txt','RACM2_EOH_A.txt','RACM2_ETEG_A.txt','RACM2_ORA1_A.txt','RACM2_MOH_A.txt',&
    ...
    'RACM2_ALD_M.txt','RACM2_ACT_M.txt','RACM2_MEK_M.txt' ,'RACM2_KET_M.txt', 'RACM2_ROH_M.txt',&
    'RACM2_HKET_M.txt','RACM2_CSL_M.txt','RACM2_PHEN_M.txt','RACM2_API_M.txt','RACM2_ISO_M.txt',&
    'RACM2_LIM_M.txt','RACM2_MVK_M.txt','RACM2_MACR_M.txt','RACM2_ONIT_M.txt','RACM2_GLY_M.txt',&
    'RACM2_MGLY_M.txt','RACM2_UALD_M.txt','RACM2_ACD_M.txt','RACM2_ORA2_M.txt','RACM2_ACE_M.txt',&
    'RACM2_BALD_M.txt','RACM2_EOH_M.txt','RACM2_ETEG_M.txt','RACM2_ORA1_M.txt','RACM2_MOH_M.txt',&
    ...
    'RACM2_CH4_P.txt','RACM2_ETH_P.txt','RACM2_HC3_P.txt' ,'RACM2_HC5_P.txt', 'RACM2_HC8_P.txt',&
    'RACM2_ETE_P.txt','RACM2_OLI_P.txt','RACM2_OLT_P.txt' ,'RACM2_DIEN_P.txt','RACM2_BEN_P.txt',&
    'RACM2_TOL_P.txt','RACM2_XYM_P.txt','RACM2_XYP_P.txt' ,'RACM2_XYO_P.txt','RACM2_HCHO_P.txt',&
    'RACM2_ALD_P.txt','RACM2_ACT_P.txt','RACM2_MEK_P.txt' ,'RACM2_KET_P.txt', 'RACM2_ROH_P.txt',&
    'RACM2_HKET_P.txt','RACM2_CSL_P.txt','RACM2_PHEN_P.txt','RACM2_API_P.txt','RACM2_ISO_P.txt',&
    'RACM2_LIM_P.txt','RACM2_MVK_P.txt','RACM2_MACR_P.txt','RACM2_ONIT_P.txt','RACM2_GLY_P.txt',&
    'RACM2_MGLY_P.txt','RACM2_UALD_P.txt','RACM2_ACD_P.txt','RACM2_ORA2_P.txt','RACM2_ACE_P.txt',&
    'RACM2_BALD_P.txt','RACM2_EOH_P.txt','RACM2_ETEG_P.txt','RACM2_ORA1_P.txt','RACM2_MOH_P.txt',&
...
!    SCALA CO   NH3   NO  NO2  SO2     CH4	ETH	HC3	HC5	HC8
!          ETE	OLI	OLT	DIEN	BEN	TOL	XYM	XYP	XYO	HCHO
!          ALD	ACT	MEK	KET	ROH	HKET	CSL	PHEN	API	ISO
